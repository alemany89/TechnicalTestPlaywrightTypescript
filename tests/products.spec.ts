...
test.describe("Products Feature", () => {
  ...
  test("Buying a product successfully", async ({ productsPage, yourCartPage , checkoutYourInformationPage , checkoutOverview , checkoutComplete}) => {
	...
	await test.step("And I fill in the checkout information", async () => {
	  await checkoutYourInformationPage.fillCheckoutInformation("Luis", "Joaquin", "41008");
	});
